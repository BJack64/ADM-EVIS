...
{
    public partial class FakturPajakOutstanding
    {
    ...
    /// </summary>     
    public class FakturPajakOutstandingExpired
    {
        public int ExpiredFakturPajak { get; set; }
        public int NotExpiredFakturPajak { get; set; }
        public int PajakTidakSesuai { get; set; }
        public int PajakValidasiStatus { get; set; }

        public int PajakValidasiStatusBlankDanBelumBypass { get; set; }
    }
    public partial class FakturPajakOutstanding : ApplicationObject, IApplicationObject
    {
