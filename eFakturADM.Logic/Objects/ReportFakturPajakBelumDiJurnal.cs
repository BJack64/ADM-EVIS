...
{
    public partial class ReportFakturPajakBelumDiJurnal
    {
    ...
    public partial class ReportFakturPajakBelumDiJurnal
    {
        ...
        public int? MasaPajakSpm { get; set; }
        public int? TahunPajakSpm { get; set; }
        public string FpNoSpm { get; set; }
        
    }
    public partial class ReportFakturPajakBelumDiJurnal : ApplicationObject, IApplicationObject
    {
        public bool Load(IDataReader dr)
        {
            ...
            MasaPajakSpm = DBUtil.GetIntNullField(dr, "MasaPajakSpm");
            TahunPajakSpm = DBUtil.GetIntNullField(dr, "TahunPajakSpm");
            FpNoSpm = DBUtil.GetCharField(dr, "FpNoSpm");
